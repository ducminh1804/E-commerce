...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DUCMINH\\DUCMINH;Initial Catalog=Ecommerce;Persist Security Info=True;User ID=sa;Password=***********;Trust Server Certificate=True;Trusted_Connection=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<KhachHang>(entity =>
        {
            ...
            entity.Property(e => e.HieuLuc).HasDefaultValue(false);
        ...
        modelBuilder.Entity<LichSu>(entity =>
        {
            ...
            entity.Property(e => e.MaKh)
                .HasMaxLength(20)
                .HasColumnName("MaKH");
            entity.Property(e => e.LichSu1)
                .HasMaxLength(250)
                .HasColumnName("LichSu");

            entity.HasOne(d => d.MaKhNavigation).WithOne(p => p.LichSu)
                .HasForeignKey<LichSu>(d => d.MaKh)
                .OnDelete(DeleteBehavior.ClientSetNull)
